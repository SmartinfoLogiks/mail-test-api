...
$mailConfig = [
	...
	"smtp_auth"=> true,
	"smtp_secure"=> "tls",
	"smtp_username"=> "AKIAIHTZWA6EKOZHP5AA",
	"smtp_password"=> "Ar5RJ6T63X265Q1EoH7mL5v+NnXVvAf9qXq8kCA+Fb0q",
	"default_from"=> "noreply@smartinfologiks.net",
	"debug"=> false,
	"smtp_ssl" => [
		'verify_peer' => false,
...
foreach($mailConfig as $a=>$b) {
	...
	if(isset($_POST[$a])) {
		if($a=="smtp_auth") {
			$mailConfig[$a] = ($_POST[$a]=="true"?true:false);
		} else {
